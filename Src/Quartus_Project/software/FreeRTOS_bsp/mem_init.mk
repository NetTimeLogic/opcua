...
$(MEM_0)_HIERARCHICAL_PATH := mem_0
$(MEM_0)_WIDTH := 32
...
.PHONY: mem_0
mem_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
# Memory: tse_descriptor_memory_0
MEM_2 := Nios_tse_descriptor_memory_0
$(MEM_2)_NAME := tse_descriptor_memory_0
...
$(MEM_2)_END := 0x00001fff
$(MEM_2)_SPAN := 0x00002000
$(MEM_2)_HIERARCHICAL_PATH := tse_descriptor_memory_0
$(MEM_2)_WIDTH := 32
$(MEM_2)_HEX_DATA_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: tse_descriptor_memory_0
tse_descriptor_memory_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
